                    ...
                    setTimeout(function checkWarn() {
                        if (t)
                            if (
                                ...
                                var e =
                                    'object' == typeof B ? B : t && window.gsap
                                t &&
                                    window.console &&
                                    !window._gsapWarned &&
                                    'object' == typeof e &&
    ...
    function ScrollSmoother(t) {
                    ...
                    for (c = 0; c < t.length; c++)
                        if (
                            ...
                            e.trigger &&
                                ...
                                ((a =
                                    f._startNative || f._startClamp || f.start),
                    ...
                    var t = (function _autoDistance(e, t) {
                        ...
                        return (
                            0 < c &&
                                ((n =
                                    0.5 ==
                                    (r = s.height / (L.innerHeight + s.height))
                                        ? 2 * s.height
                                        : 2 *
                                          Math.min(
                                              s.height,
        ...
        function refreshHeight() {
            return (
                ...
                (q.style.height =
                    L.innerHeight + (e - L.innerHeight) / A + 'px'),
                e - L.innerHeight
            )
        }
        bb(),
                    ...
                    ? ((w =
                          ...
                          (function _wrap(e) {
                              ...
                              return (
                                  t ||
                                      ((t =
                                          I.createElement('div')).classList.add(
